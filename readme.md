...
:new: **AI Playground 3.1.2 beta-hf (all SKUs)** - [Release Notes](https://github.com/intel/AI-Playground/releases/tag/v3.1.2-beta_hf) | [Windows Installer](https://github.com/intel/AI-Playground/releases/download/v3.1.2-beta_hf/AI-Playground-installer.exe) | [Linux Installer](https://github.com/intel/AI-Playground/releases/download/v3.1.2-beta_hf/AI-Playground-installer.deb)
